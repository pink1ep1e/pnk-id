...
export function Support(p: IconProps) {
  return (
    <Svg {...p}>
      <path d="M3 11v3a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1Z" />
      <path d="M18 10h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1Z" />
...
export function Call(p: IconProps) {
  return (
    <Svg {...p}>
...
export function QrCode(p: IconProps) {
  return (
    <Svg {...p} fill="currentColor" strokeWidth={0}>
      <path d="M3 3h8v8H3V3zm2 2v4h4V5H5zm8-2h8v8h-8V3zm2 2v4h4V5h-4zM3 13h8v8H3v-8zm2 2v4h4v-4H5zm13-2h1v2h-1v-2zm-3 0h2v1h-2v-1zm0 3h1v1h-1v-1zm2 0h3v1h-1v2h-1v-2h-1v-1zm-2 2h1v3h-1v-3zm3 2h2v1h-2v-1z" />
    </Svg>
  );
}
